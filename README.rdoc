...
==Step 3 I am currently here as of Friday night. Continued for a few hours on Sunday. Step 3 creates a new tour object, passes in the user information and uses a checkbox to allow them to pick from amenities. So far this was the most challenging thing to work on, it was pretty awesome to get work and see the values going back into the controller. I was then starting to work on the user IP address, and though I started on it, time ran out and it i WIP.
==Step 4 This leaves off at step 4 on 12/14 to do what I could in 5-6 hours.
