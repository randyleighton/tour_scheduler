...
===As of Friday night, I would still like to spend a few more hours in this Sunday, but I wanted to push this all to Github to have status progress online. 
-
...
==Step 3 I am currently here as of Friday night.
From here I plan to create a new tour and take the values from them to set the tour date and amenities. I created an amenities table and plan to use that with the checkboxes. then creating 2 mailers to send out should be fairly easy now since there is already mailing in place.
